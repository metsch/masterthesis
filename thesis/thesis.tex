...
\usepackage{seqsplit}
\usepackage[acronym,toc,nonumberlist]{glossaries} % Enables the generation of glossaries and lists fo acronyms. This package has to be included last.
...
\makenoidxglossaries % Use an optional glossary.
...
% Use an optional list of tables. % Start list of tables on the next empty right hand page.
