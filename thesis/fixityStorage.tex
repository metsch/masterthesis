...
\begin{lstlisting}[language=Solidity,caption={MVP source code of the fixity storage deployed on the Ropsten test network https://Ropsten.etherscan.io/address/0x0243c7aa552730E8C6F7ED25A480a7C0c88a70f0},label={lst:fixity-storage}]
...
\section{Cost of interacting}\label{sec:cost-interating}
